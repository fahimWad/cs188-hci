...
const FloatingFlashcard: React.FC<FloatingFlashcardProps> = ({
  ...
  return (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 translate-x-12 bg-transparent text-white-25 rounded-xl z-50 w-[400px] h-[250px] [perspective:1000px] flex flex-col">
      ...
      >
      {/* Flashcard header */}
      <div className={`absolute ${flipped ? "bottom-0" : "top-0"} left-0 w-full flex justify-between items-center px-4 py-2 z-20 pointer-events-auto ${flipped ? "[transform:rotateX(180deg)]" : ""}`}>
      ...
      >
        ...
        <p className="text-center p-2 font-bold">New Term</p>
        )}
      </div>
      {/* Flashcard back */}
      <div
