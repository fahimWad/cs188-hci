    ...
    return (
        <div className="absolute top-0 left-0 h-full w-[90px] z-[100] bg-neutral-1 flex flex-col justify-center items-center gap-4 p-4 bg-neutral-1">
            <button
                ...
                className={`p-4 rounded-lg ${location.pathname === "/pdf" ? "bg-primary-1 text-white" : "bg-gray-200 text-neutral-1"}`}
            ...
            <button
                ...
                className={`p-4 rounded-lg ${location.pathname === "/graph" ? "bg-primary-1 text-white" : "bg-gray-200 text-neutral-1"}`}
